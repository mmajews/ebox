...
GTA.loader = function (file) {
    ...
    */
    ...
    GTA.ajaxLoader.call(this, "GTA/data/MISSION.INI", function( data ) {
...
GTA.parseSDT = function ( data, number ) {
    ...
    GTA.ajaxLoader.call(this, "GTA/data/LEVEL00" + number + ".RAW", function(audioData) {
...
GTA.parseCMP = function ( data ) {
    ...
    /*
    GTA.ajaxLoader.call(this, "GTA/data/LEVEL00" + fileInfo.styleNumber + ".SDT", function(soundData) {
        this.sounds = GTA.parseSDT.call( this, new DataViewReader( soundData, true ), fileInfo.styleNumber );    
    });
    */
    
    GTA.ajaxLoader.call(this, "GTA/data/STYLE00" + fileInfo.styleNumber + ".G24", function(styleData) {
